from src.techniques.deterministic_techniques.scenario_decomposition.dummy_example.first_order.scenarios import Scenarios
import numpy as np
...
class SensitivityIndices(Scenarios):
    def __init__(self, order=2, negativeFeatureInfluence=False):
        super().__init__(order, negativeFeatureInfluence)
...
if __name__ == "__main__":
    indices = SensitivityIndices(order=2, negativeFeatureInfluence=False)
